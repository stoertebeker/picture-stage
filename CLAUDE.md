...
**Datum:** 2026-06-10
**Wachwechsel-Tag:** `handover-2026-06-10-a11y` (zeigt auf `92e80a7`, letzter grüner Stand: A11y-Voll-Audit + Guest-Fixes `p07.4/5/6` lokal verifiziert — **noch nicht deployed**)
...
> Vorsicht beim Re-Deploy — `p07.5` visuell abnehmen, sonst Doppel-Header-Risiko.
...
- **Offen:** `p07.7` (P3, Kontrast Guest-UI-Texte gegen Editorial-Dark-Tokens rechnerisch prüfen, unbestätigt), `p07.8` (P3, Skip-Link projektweit). `p07`-Schirm bleibt offen bis diese zwei + die visuelle p07.5-Abnahme durch sind.
- **Nächster Schritt:** Re-Deploy → `p07.5` visuell abnehmen (kein Doppel-Header) + `p07.4/6` live prüfen → dann `p07.7`/`p07.8` oder `dxj`/`dd1`.
