...
- **Offen:** `p07.7` (P3, Kontrast Guest-UI-Texte gegen Editorial-Dark-Tokens rechnerisch prüfen, unbestätigt), `p07.8` (P3, Skip-Link projektweit). `p07`-Schirm bleibt offen bis diese zwei durch sind (visuelle p07.5-Abnahme ✅ erledigt).
- **Nächster Schritt:** `p07.7`/`p07.8` (dann `p07`-Schirm schließen) oder `dxj`/`dd1`/`qdz.15`.
