...
- **Schirm `p07` geschlossen (2026-06-10):** alle 8 Sub-Findings durch (p07.1–6 prod-verifiziert). ⚠️ **`p07.7`/`p07.8` committed, aber noch nicht deployed** — beim nächsten Deploy live prüfen: Skip-Link per Tab sichtbar/springt zu #main, Complete-Modal-Button in Accent-Grün.
- **Nächster Schritt:** Deploy (CI baut aus `f15e471`) + Kurz-Check p07.7/p07.8 live → dann `dxj`/`dd1`/`qdz.15`.
